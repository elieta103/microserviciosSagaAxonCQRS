...
public class ProductEventsHandler {
	...
	public void on(ProductReservationCancelledEvent productReservationCancelledEvent) {
		...
		LOGGER.info("ProductReservationCancelledEvent: Current product quantity " + currentlyStoredProduct.getQuantity() );
		...
		LOGGER.info("ProductReservationCancelledEvent: New product quantity " + currentlyStoredProduct.getQuantity() );
