...
public class OrdersCommandController {
	...
	public OrderSummary createOrder(@Valid @RequestBody OrderCreateRest order) {
		...
		// Sincroniza que haya terminado la creación de la orden para devolverla.
		// Es para evitar que se devuelva una orden que no ha concluido, recordar que se maneja por eventos
